   ...
   public class RaportiDAL
    {
        ...
        public DataTable GetAll()
        {
            try
            {
                ...
                SqlConnection sqlcon = new SqlConnection(_connectionString);
                SqlDataAdapter sqlDataAdapter = new SqlDataAdapter("usp_Raporte_MerriRaportet", sqlcon);
        ...
        public int Update(Raporti ndeshjaModel)
        {
            try
            {
                ...
                command.Parameters.AddWithValue("@Raporti", ndeshjaModel.Raportii);
                command.Parameters.AddWithValue("@InsertBy", 1);
                command.Parameters.AddWithValue("@InsertDate", "06/05/2020");
                command.Parameters.AddWithValue("@LUB", 1);
                command.Parameters.AddWithValue("@LUD", "06/05/2020");
        ...
        public void MerrNdeshjeMeID(Raporti ndeshja)
        {
            try
            {
                ...
                sqlda.SelectCommand.Parameters.AddWithValue("@RaportID", ndeshja.NdeshjaID);
