namespace Klubi_I_Futbollit.UserControls.LojtartUserControls
{
    partial class EditoLojtarUserControl
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.panel2.Controls.Add(this.txtNumriIfanelles);
            this.panel2.Controls.Add(this.txtGjatesia);
            this.panel2.Controls.Add(this.label11);
            this.panel2.Controls.Add(this.label10);
            this.panel2.Controls.Add(this.label9);
            this.panel2.Controls.Add(this.txtPesha);
            this.panel2.Controls.Add(this.label12);
            this.panel2.Controls.Add(this.txtEmail);
            this.panel2.Controls.Add(this.txtFjalekalimi);
            this.panel2.Controls.Add(this.label1);
            this.panel2.Controls.Add(this.label8);
            this.panel2.Controls.Add(this.txtEmriPerdoruesit);
            this.panel2.Controls.Add(this.Emriperdoruesit);
            this.panel2.Controls.Add(this.label7);
            this.panel2.Controls.Add(this.txtNumriTelefonit);
            this.panel2.Controls.Add(this.txtShtetesia);
            this.panel2.Controls.Add(this.txtGrupigjakut);
            this.panel2.Controls.Add(this.txtVendlindja);
            this.panel2.Controls.Add(this.txtVendbanimi);
            this.panel2.Controls.Add(this.txtMbiemri);
